            ...
            <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                    <tr>
                        ...
                        <th scope="col" class="px-6 py-3">
                        <a href="{{ route('servicios.create') }}" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">Añadir nuevo</a>
                ...
                @forelse($servicios as $servicio)
                    <tbody>
                        <tr class="odd:bg-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 border-b dark:border-gray-700 border-gray-200">
                            ...
                            <td class="px-6 py-4">
                                <a href="{{ route('servicios.show', parameters: $servicio->id) }}" class="font-medium text-blue-600 dark:text-yellow-500 hover:underline">Ver</a>
                            </td>
                            <td class="px-6 py-4">
